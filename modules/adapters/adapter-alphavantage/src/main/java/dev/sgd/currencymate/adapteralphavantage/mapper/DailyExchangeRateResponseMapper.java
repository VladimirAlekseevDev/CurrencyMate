...
public interface DailyExchangeRateResponseMapper {
    ...
    default void setCurrenciesNameAndType(@MappingTarget ExchangeRateDaily exchangeRateDaily,
                                          Currency fromCurrency,
                                          Currency toCurrency) {
        exchangeRateDaily.getFrom().setName(fromCurrency.getName());
        exchangeRateDaily.getFrom().setType(fromCurrency.getType());

        exchangeRateDaily.getTo().setName(toCurrency.getName());
        exchangeRateDaily.getTo().setType(toCurrency.getType());
    }
